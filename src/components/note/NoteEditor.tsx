                ...
                <div className="flex items-center gap-8">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 text-[14px] font-semibold transition-all group cursor-pointer ${
                            note.isPinned ? 'text-teal-500' : 'text-slate-400 hover:text-slate-600'
                        }`}
                    >
                        <MdPushPin className={`text-[18px] transition-transform ${note.isPinned ? 'rotate-45' : 'group-hover:-rotate-12'}`}/>
