...
const KanbanCard = ({ task, onClick, onDragStart }: KanbanCardProps) => {
  ...
  return (
    <div
      ...
      className="bg-white border border-[var(--wh-green-border-light)] rounded-lg p-4 cursor-pointer transition-all duration-200 hover:border-[var(--wh-green-primary)] hover:shadow-md group"
    >
      {/* Labels */}
      ...
      {/* Title */}
      <h4 className="font-medium text-sm text-gray-900 mb-3 line-clamp-2 group-hover:text-[var(--wh-green-text-primary)]">
        {task.title}
      </h4>
