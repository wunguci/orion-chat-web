  ...
  return (
    <div className="bg-white border border-wh-green-border-light rounded-xl p-5">
      <h3 className="text-sm font-semibold text-gray-800 mb-4">
        <i className="fas fa-users mr-2 text-wh-green-primary"></i>
        Team Performance
      </h3>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-wh-green-border-light">
          ...
          <tbody>
            {data.map((member) => {
              ...
              return (
                <tr key={member.user.id} className="border-b border-wh-green-border-light last:border-0">
