    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Transfer Task" size="sm">
      <div className="p-6 space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-2">
          <button
            onClick={onClose}
            className="px-4 py-2 border border-[var(--wh-green-border-light)] text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm"
          >
            Cancel
          </button>
          <button
            ...
            className="px-4 py-2 bg-[var(--wh-green-primary)] text-white rounded-lg hover:bg-[var(--wh-green-primary-hover)] transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
