            ...
            <div className="flex-1 overflow-y-auto py-4 px-3">
                ...
                <div className="mb-5">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <i
                                    className={`fas ${item.icon} w-5 text-center text-sm`}
                                ></i>
                ...
                <div className="mb-5 hidden">
                    ...
                    {channels.slice(0, 5).map((channel) => {
                        ...
                        const active =
                            ...
                            location.search.includes(channel.id);
                        return (
                            <Link
                                key={channel.id}
                                to={`/work-hub/${workspaceId}/channels`}
                            ...
                            >
                                ...
                                {channel.unreadCount > 0 && (
                                    <span className="text-[10px] font-bold bg-red-500 text-white px-1.5 py-0.5 rounded-full min-w-4.5 text-center">
                                        {channel.unreadCount}
                                    </span>
                                )}
                            </Link>
                ...
                <div className="mb-5 hidden">
                    ...
                    {dmThreads.map((thread) => {
                        ...
                        const active =
                            isActive(dmPath) &&
                            location.search.includes(thread.id);
                        return (
                            <Link
                                key={thread.id}
                                to={`/work-hub/${workspaceId}/messages`}
                            ...
                            >
                                ...
                                {thread.unreadCount > 0 && (
                                    <span className="text-[10px] font-bold bg-wh-green-primary text-white px-1.5 py-0.5 rounded-full min-w-4.5 text-center">
                                        {thread.unreadCount}
                                    </span>
                                )}
                            </Link>
