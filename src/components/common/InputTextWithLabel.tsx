    ...
    return (
        <div className="flex flex-col gap-2 shrink w-full">
            ...
            <div className="relative flex items-center group">
                ...
                {Icon && (
                    <Icon
                        className="absolute left-3 text-gray-400 group-focus-within:text-[#ee652b] transition-colors"
                        size={20}
                    />
                )}
                ...
                <input
                    ...
                    className={`w-full py-2 border border-gray-200 rounded-lg text-[#505050] focus:outline-none focus:ring-2 focus:ring-[#ee652b] transition-all
