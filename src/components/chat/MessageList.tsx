      ...
      >
        {myIsHidden ? (
          ...
          socketMessages.map((msg) => {
            ...
            const isSystemMessage = normalizedMessageType === "SYSTEM";
                ...
                >
                    ...
                    <>
                      ...
                      >
                        {msg.isPinned && (
                          <div
                            className={`mb-1 text-[11px] font-semibold ${
                              isMe ? "text-white/80" : "text-amber-600"
                            }`}
                          >
                        ...
                        {msg.isRecalled ? (
                          ...
                          <a
                            href={
                              toAbsoluteMediaUrl(msg.fileUrl) || msg.fileUrl
                            }
                            target="_blank"
                            rel="noopener noreferrer"
                    ...
                    >
                      ...
                      {openActionMenuKey === messageKey && (
                        ...
                        >
                          ...
                          {(onAISummarize || onAIReplySuggestions) && (
                            ...
                            <>
                              ...
                              {[1, 2, 3].map((month) => (
                                <button
                                  key={month}
                                  onClick={() => {
                                    onAISummarize("range", month as 1 | 2 | 3);
                                    setOpenActionMenuKey(null);
                                  }}
                                  className="w-full px-4 py-2 text-left text-sm text-slate-700 hover:bg-sky-50"
                                >
                  ...
                  {!isMe && emotionHint && (
                    <div className="mt-1 flex items-center gap-1 rounded-full border border-slate-200 bg-white/70 px-2 py-0.5 text-[11px] text-slate-500 opacity-60">
                      ...
                      <span className="capitalize">{emotionHint.label}</span>
                    </div>
                  )}
                </div>
              </div>
