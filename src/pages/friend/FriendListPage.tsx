...
const FriendListPage = () => {
    ...
    const [chatLoadingFriendId, setChatLoadingFriendId] = useState<
        string | null
    >(null);
    ...
    useEffect(() => {
        ...
        const loadData = async () => {
            ...
            const blockedRes =
                await friendListService.getBlockedFriends(userId);
    ...
    const handleCallFromProfile = async (friendId: string) => {
        ...
        if (callStatus !== 'idle') {
            window.alert(
                "I'm currently on another call. Please try again later.",
            );
            return;
        }
