...
export const ChatPage: React.FC = () => {
    ...
    const selectedGroupInfoOverride =
    ...
    useEffect(() => {
        ...
        for (const conversation of conversations) {
            ...
            if (sidebarJoinedConversationIdsRef.current.has(conversationId))
                continue;
            ...
            void joinConversation(
                ...
                .then((ack) => {
                    if (!isCancelled && ack?.ok) {
                        sidebarJoinedConversationIdsRef.current.add(
                            conversationId,
                        );
                    }
                })
                ...
                .finally(() => {
                    sidebarJoiningConversationIdsRef.current.delete(
                        conversationId,
                    );
                });
        }
            ...
            .then((settings) => {
                if (mounted) {
                    ...
                    setAutoWorkflowEnabled(
                        settings.autoWorkflowSuggestions !== false,
                    );
                }
            })
            .catch(() => {
