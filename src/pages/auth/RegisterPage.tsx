        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {step === 1 && (
            <>
              <p className="text-center text-gray-400">
                Enter your phone number to get started with our social community
              </p>
                  ...
                  {(() => {
                    ...
                    const Item = ({
                      ...
                      <li className="flex items-center gap-3 pl-2">
                        ...
                        <span
                          className={ok ? "text-[#2AB3B3] " : "text-gray-400"}
                        >
                          {children}
                        </span>
                      </li>
                    ...
                    return (
                      <>
                        <Item ok={hasLength}>At least 8 characters</Item>
                        <Item ok={hasSpecial}>At least one special symbol</Item>
                        <Item ok={hasNumber}>At least one number</Item>
                      </>
                    );
                  })()}
                </ul>
              ...
              <p className="text-center text-gray-400">
                By tapping Next, you may receive an SMS for verification.
          ...
          {step === 2 && (
            <>
              ...
              <p className="text-center text-gray-400">
                By entering the code, you agree to our Terms of Service and
                Privacy Policy
              </p>
            </>
          )}
          ...
          {step === 3 && (
            <>
              ...
              <p className="text-center text-gray-400">
                By tapping "Complete", you agree to our Terms of Service and
                Privacy Policy We use your data to enhance your discovery
                experience.
              </p>
            </>
          )}
